...
def validate_arguments(func, args, kwargs, drop_extra=True):
    ...
    a view function::
        ...
        from werkzeug.util import ArgumentValidationError, validate_arguments
...
class MultiDict(_MultiDict):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "'werkzeug.util.MultiDict' has moved to 'werkzeug"
...
class CombinedMultiDict(_CombinedMultiDict):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "'werkzeug.util.CombinedMultiDict' has moved to 'werkzeug"
...
class Headers(_Headers):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "'werkzeug.util.Headers' has moved to 'werkzeug"
...
class EnvironHeaders(_EnvironHeaders):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "'werkzeug.util.EnvironHeaders' has moved to 'werkzeug"
...
def parse_cookie(*args, **kwargs):
    warnings.warn(
        "'werkzeug.util.parse_cookie' as moved to 'werkzeug.http"
...
def dump_cookie(*args, **kwargs):
    warnings.warn(
        "'werkzeug.util.dump_cookie' as moved to 'werkzeug.http"
